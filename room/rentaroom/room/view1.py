...
@api_view(['PUT'])
def rental_contract_confirm(request, pk):
  
  """
  confirm a rental contract by renter. the contract was generated by room owner
  """
  try:
    rental_contract = RentalContract.objects.get(pk=pk)
  except RentalContract.DoesNotExist:
    return Response(status=status.HTTP_404_NOT_FOUND)
    
  if request.method =='PUT':
    serializer = RentalContractSerializer(rental_contract, data=request.DATA)
